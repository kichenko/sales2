...
<html>
    <head>
        <title>Отчёт почасовой статистики</title>
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/js/report/discount-by-hour-grid.js"></script>
